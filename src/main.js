...
const initAdminMenu = (router, store) => {
  ...
  var adminMenu = [
    ...
    },
    {
      ...
      children: [
        {
          path: '/admin/content/overall',
          name: 'overallManagement',
          nameZh: '总体信息',
          iconCls: null,
          component: 'content/OverallView',
          parentId: 4,
          children: []
        },
        {
  ...
  if (store.state.type === 1) {
    fmtRoutes = formatRoutes(adminMenu)
  } else {
    fmtRoutes = formatRoutes(menu)
  }
  router.addRoutes(fmtRoutes)
  store.commit('initAdminMenu', fmtRoutes)
